        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    <input type="time" class="form-control" id="tanggal_selesai2" name="tanggal_selesai2" value="<?php echo date('H:i:s', strtotime($data_cek['tanggal_selesai'])); ?>" />
                </div>
            </div>
...
if (isset($_POST['Ubah'])) {
    ...
    $tglselesai = $d . " " . $d1;
    $sql_ubah = "UPDATE tb_daftarvote SET 
    nama='" . $_POST['nama'] . "',
