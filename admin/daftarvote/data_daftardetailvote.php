                ...
                <div class="table-responsive">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <?php
                            $no = 1;
                            $query = "select a.votekandidat_id, a.daftarvote_id, b.nama_pegawai, 
                                b.id_calon, b.nip_bps, b.jabatan, a.no_urut from tb_votekandidat a
                                join tb_calon b on a.id_calon=b.id_calon 
                                where a.flag_id=1 and a.daftarvote_id=" . $kode;
					...
					<table id="example3" class="table table-bordered table-striped">
						...
						<tbody>
							...
							$sql = $koneksi->query(
								...
								b.nama_pegawai, b.username, a.status_id
